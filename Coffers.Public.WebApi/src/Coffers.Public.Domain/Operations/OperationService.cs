...
namespace Coffers.Public.Domain.Operations
{
    public sealed class OperationService
    {
        ...
        public async Task PutLoan(Guid loanId,
            Guid toAccountId,
            Guid fromAccountId,
            Decimal loanAmount,
            Decimal loanTax,
        ...
        {
            var fromAccount = await _oRepository.GetAccount(fromAccountId, cancellationToken);
            var toAccount = await _oRepository.GetAccount(toAccountId, cancellationToken);
        ...
        public async Task CancelLoan(Guid loanId,
            CancellationToken cancellationToken = default)
        {
            var loansOperations = await _oRepository.GetOperationWithDocIdAndType(loanId, OperationType.Loan, cancellationToken);
            var loan = await _oRepository.GetLoan(loanId, cancellationToken);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task AddOtherOperation(Guid id,
            Guid fromAccountId,
            Guid toAccountId,
            Decimal amount,
            String description = "",
            CancellationToken cancellationToken = default)
        {
            var operation = await _oRepository.Get(id, cancellationToken);
        ...
        /// <returns></returns>
        public async Task DoOutputOperation(Guid id,
            Guid fromAccountId,
            Guid toAccountId,
            Decimal amount,
            String description = "",
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task DoInternalOutputOperation(Guid id,
            Guid fromAccountId,
            Guid toAccountId,
            Decimal amount,
            String description = "",
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task AddSellOperation(Guid id,
            Guid toAccountId,
            decimal amount,
            string description,
            CancellationToken cancellationToken = default)
        ...
        public async Task AddDealOperation(
            Guid id,
            Guid guildAcc,
            Guid fromUserAcc,
            Guid toUserAcc,
        ...
        {
            var operation = await _oRepository.Get(id, cancellationToken);
            if (operation != null && (operation.Type != OperationType.Deal || operation.Amount != amount))
                throw new OperationException("Operation already exists");
            if (operation != null)
                return;

            var fromUserAccount = await _oRepository.GetAccount(fromUserAcc, cancellationToken);
            var toUserAccount = await _oRepository.GetAccount(toUserAcc, cancellationToken);
            var guildAccount = await _oRepository.GetAccount(guildAcc, cancellationToken);
            var operations = new[] {
                new Operation
                {
                    Id = id,
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task AddTaxOperation(Guid id,
            Guid fromAccountId,
            Guid toAccountId,
            Decimal amount,
            String description = "",
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task AddPenaltyOperation(Guid id,
            Guid guildAccountId,
            Guid penaltyId,
            Decimal amount,
            String description,
            CancellationToken cancellationToken = default)
        {
            ...
            var penalty = await _oRepository.GetPenalty(penaltyId, cancellationToken);

            var gamerAccount = penalty.Gamer.DefaultAccount;
            var guildAccount = await _oRepository.GetAccount(guildAccountId, cancellationToken);

            var penaltyOpSum = (await _oRepository.GetOperationWithDocIdAndType(penaltyId, OperationType.Penalty, cancellationToken))
                .Sum(_ => _.Amount);
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task AddLoanOperation(Guid id,
            Guid guildAccAccountId,
            Guid loanId,
            Decimal amount,
            String description,
            CancellationToken cancellationToken = default)
        {
            ...
            var guildAccount = await _oRepository.GetAccount(guildAccAccountId, cancellationToken);
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task EmissionOperation(Guid id,
            Guid guildAccountId,
            Decimal amount,
            String description,
            CancellationToken cancellationToken = default)
        {
            ...
            var toAccount = await _oRepository.GetAccount(guildAccountId, cancellationToken);
            toAccount.ChangeBalance(amount);
            await _oRepository.Save(new Operation
            {
                Id = id,
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public async Task DoInternalEmissionOperation(Guid id,
            Guid gamerAccountId,
            Guid guildAccAccountId,
            Decimal amount,
            String description,
            CancellationToken cancellationToken = default)
        {
            ...
            var gamerAccount = await _oRepository.GetAccount(gamerAccountId, cancellationToken);
            var guildAccount = await _oRepository.GetAccount(guildAccAccountId, cancellationToken);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task DoExchangeOperation(Guid id,
            Guid accountId,
            Decimal amount,
            String description = "",
            CancellationToken cancellationToken = default)
        {
            ...
            var account = await _oRepository.GetAccount(accountId, cancellationToken);
